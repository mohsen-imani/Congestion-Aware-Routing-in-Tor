...
#ifndef TOR_OR_H
#define TOR_OR_H
#define LIST_LEN_MOH 30//iSec
#define DEFAULT_MEAN_MOH 250//iSec
#include "orconfig.h"
...
//iSec-------------------------------------------------------
  ...
  float lon;
  int isec_selected;
  char node_ip[INET_NTOA_BUF_LEN+1];
//iSec-------------------------------------------------------
} node_t;
...
//iSec-----------------------------------
	...
	float glon;
        ...
        uint32_t mbw;
        uint32_t ebw;
        char exit_ip[INET_NTOA_BUF_LEN+1];
        char middle_ip[INET_NTOA_BUF_LEN+1];
        char entry_ip[INET_NTOA_BUF_LEN+1];
	float pop_lat;
        float pop_lon;
	int rand_no;
//iSec-----------------------------------
...
#define MAX_MAX_CLIENT_CIRCUITS_PENDING 1024
  ...
  int POWER_GUARD;
  int POP_DEST_NUM;
  int OPEN_CIRCUITS_ISEC;
  int OPEN_CIRCUITS_BOOTSTRAP_ISEC;
  int OPEN_CIRCUITS_PER_PORT_ISEC;
  int ISEC;
  int CIRC_NUM_RANDOM_ISEC;
  int CIRC_LIFE_TIME_ISEC;
  int MYLOG;
